...
export const Login: React.FC = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      ...
      >
        <h2 className="text-3xl font-bold text-center mb-8 text-white">Вход</h2>
        ...
        <div className="mt-6 text-center text-sm text-glam-text/60">
          Нет аккаунта?{' '}
          <Link to="/register" className="text-glam-accent hover:text-white hover:underline transition-colors">
            Создать
          </Link>
        </div>
      </motion.div>
